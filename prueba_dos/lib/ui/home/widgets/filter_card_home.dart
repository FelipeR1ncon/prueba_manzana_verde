...
class _CardFilterState extends State<CardFilter> {
  ///Opciones para mostrar en el bottomSheet de orden
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => showBottomSheetBrandsFilter(),
            child: SizedBox(
                width: MediaQuery.of(context).size.width * 0.45,
                child: FilterCard(
                        ...
                        for (int i = 0;
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: AutoSizeText(
                                  optionsOrder.entries.toList()[i].key,
                                  maxLines: 3,
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Radio(
                                    value: i,
                                    groupValue: _indexSelectedInOrder,
                                    activeColor: LocalColors.greenV200,
                                    onChanged: (newIndex) {
                                      setState(() {
                                        _indexSelectedInOrder = newIndex as int;
                                      });
                                      setModalState(() {});
                                    },
                                  ),
                  ...
                  child: Padding(
                    ...
                    child: Wrap(
                      children: [
                        ...
                        Wrap(children: [
                          for (var brand in optionsBrand.entries.toList())
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(
